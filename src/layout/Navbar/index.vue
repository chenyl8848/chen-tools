<template>
    <div>
        <div class="navbar">
            ...
            <a-input v-model:value="keyword" placeholder="请输入关键词搜索" @keydown.enter="onSearch" clearable
                @click="onSearch">
                <template #suffix>
...
import { getSearchTools } from '@/utils/tools'
...
watch(() => searchText.value, (newValue) => {
    searchTools.value = getSearchTools(searchText.value)
})

const routerJump = (tool) => {
